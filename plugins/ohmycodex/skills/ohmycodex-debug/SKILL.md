...
For intermittent or multi-module failures, use `ohmycodex-team` to parallelize Explorer and QA evidence gathering. Consolidate competing hypotheses before assigning a debugger or implementer; never run parallel repair agents.
