...
For a complex approved plan, use `omc-team` only for read-only support such as Explorer, Librarian, or QA. Wait for their summaries before editing. The implementer remains the sole code-writing agent for the milestone.
