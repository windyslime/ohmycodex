...
After user approval, write `.ohmycodex/specs/mvp.md`. Mark unknown integrations or policy decisions as blockers instead of inventing data or APIs. Hand off technical choices to `ohmycodex-architecture`.
