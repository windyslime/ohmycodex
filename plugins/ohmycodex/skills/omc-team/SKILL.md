...
When `.ohmycodex/` is writable, create `.ohmycodex/plans/team-runs/<timestamp>.md` with the objective, roles, requested models, fallback substitutions, result summaries, evidence, unresolved risks, and final decision. Read `../omc-orchestrator/references/workspace-contract.md` before writing it.
